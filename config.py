...
misc_arg.add_argument('--num_model', type=int, default=2,
...
misc_arg.add_argument('--data_dir', type=str, default='D:\OneDrive - University of Connecticut\Course\CSE 5819\Paper Review\Omniglot Dataset\changed',
