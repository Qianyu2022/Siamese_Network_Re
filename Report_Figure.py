...
#               0.103, 0.077, 0.074]
# 150000 training pairs results
train_acc = [65.9375, 75, 79.375, 80.9375, 85.3125, 84.375, 85.625, 85.625, 84.6875
            ,86.875, 88.75, 89.375, 89.375, 87.1875, 84.6875, 86.25, 88.75, 87.8125
            ,85.9375, 90.3125, 89.6875, 89.6875, 90, 90 , 90.9375, 89.375, 87.8125
            ,90.625, 90.625, 90, 90, 86.875, 89.6875, 90.625, 90.9375]
train_loss = [0.286, 0.151, 0.115, 0.095, 0.087, 0.079, 0.074, 0.070, 0.066,
              0.063, 0.060, 0.059, 0.057, 0.053, 0.054, 0.053, 0.052, 0.049,
              0.050, 0.050, 0.048, 0.046, 0.046, 0.043, 0.046, 0.044, 0.044,
              0.043, 0.041, 0.044, 0.041, 0.041, 0.040, 0.042, 0.041]

# plot the train loss and train accuracy
# the x-axis is the number of epochs
# the y-axis is the loss or accuracy
plt.figure(figsize=(10, 5))
plt.plot(range(1, 36), train_loss)
