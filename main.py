...
'''
train_loader, valid_loader = get_train_valid_loader(data_dir='D:\OneDrive - University of Connecticut\Course\CSE 5819\Paper Review\Omniglot Dataset\changed', batch_size=32, pin_memory=True)
